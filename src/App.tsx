    ...
    <div className="min-h-screen bg-zinc-900 text-zinc-50">
      ...
      <div className="max-w-4xl mx-auto pt-12">
        <header className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white flex items-center justify-center gap-1">
          ...
          <p className="mt-2 text-zinc-200">Share files magically through QR codes!</p>
        </header>
